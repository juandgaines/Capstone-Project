...
public class FATRN extends BaseNutrient implements Parcelable {
    ...
    public static final Parcelable.Creator<FATRN> CREATOR = new Parcelable.Creator<FATRN>(){
        ...
        @Override
        public FATRN createFromParcel(Parcel parcel) {
            return new FATRN(parcel);
        }
