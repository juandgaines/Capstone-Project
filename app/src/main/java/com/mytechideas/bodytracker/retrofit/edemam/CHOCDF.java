...
public class CHOCDF extends BaseNutrient implements Parcelable{
    ...
    public static final Parcelable.Creator<CHOCDF> CREATOR = new Parcelable.Creator<CHOCDF>(){
        ...
        @Override
        public CHOCDF createFromParcel(Parcel parcel) {
            return new CHOCDF(parcel);
        }
