...
public class NA_ extends BaseNutrient implements Parcelable {
    ...
    public static final Parcelable.Creator<NA_> CREATOR = new Parcelable.Creator<NA_>(){

        @Override
        public NA_ createFromParcel(Parcel parcel) {
            return new NA_(parcel);
        }

        @Override
        public NA_[] newArray(int size) {
            return new NA_[0];
        }
    };
