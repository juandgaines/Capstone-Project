...
public class FOLDFE extends BaseNutrient implements Parcelable {
    ...
    public static final Parcelable.Creator<FOLDFE> CREATOR = new Parcelable.Creator<FOLDFE>(){
        ...
        @Override
        public FOLDFE createFromParcel(Parcel parcel) {
            return new FOLDFE(parcel);
        }
