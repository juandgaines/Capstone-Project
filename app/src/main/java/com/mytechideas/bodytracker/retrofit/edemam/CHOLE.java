...
public class CHOLE extends BaseNutrient implements Parcelable{
    ...
    public static final Parcelable.Creator<CHOLE> CREATOR = new Parcelable.Creator<CHOLE>(){
        ...
        @Override
        public CHOLE createFromParcel(Parcel parcel) {
            return new CHOLE(parcel);
        }
